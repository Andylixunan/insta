...
var file_api_proto_user_user_proto_depIdxs = []int32{
	...
	5, // 7: user.UserService.GetUserByUsername:input_type -> user.GetUserByUsernameRequest
	...
	4, // 10: user.UserService.GetUserByUsername:output_type -> user.GetUserResponse
