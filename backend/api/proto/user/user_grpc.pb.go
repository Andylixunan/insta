...
type UserServiceClient interface {
	...
	GetUserByUsernameAndPassword(ctx context.Context, in *GetUserByUsernameAndPasswordRequest, opts ...grpc.CallOption) (*GetUserResponse, error)
...
func (c *userServiceClient) GetUserByUsernameAndPassword(ctx context.Context, in *GetUserByUsernameAndPasswordRequest, opts ...grpc.CallOption) (*GetUserResponse, error) {
	out := new(GetUserResponse)
	err := c.cc.Invoke(ctx, "/user.UserService/GetUserByUsernameAndPassword", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	GetUserByUsernameAndPassword(context.Context, *GetUserByUsernameAndPasswordRequest) (*GetUserResponse, error)
...
func (UnimplementedUserServiceServer) GetUserByUsernameAndPassword(context.Context, *GetUserByUsernameAndPasswordRequest) (*GetUserResponse, error) {
...
func _UserService_GetUserByUsernameAndPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.UserService/GetUserByUsernameAndPassword",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
